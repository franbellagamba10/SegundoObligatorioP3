...
namespace Tests
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //RepositorioFichasEF repoFichas = new RepositorioFichasADO(repoFR, repoTI);
            //RepositorioPlantasEF repoPlantas = new RepositorioPlantasEF(repoTipos, repoFichas, repoUsuarios);
