...
VALUES
(0,'francesco@ort.edu.uy','Francesco1992!',1),
(1,'plinio@ort.edu.uy','Plinio1972!',1),
(2,'juanmanuel@ort.edu.uy','Juanma1995!',1),
(3,'martin@ort.edu.uy','Martin1991!',1),
(4,'gervaz@ort.edu.uy','Gervaz1951!',1);

---------------------------------------------------------------------------
INSERT into TipoPlanta
VALUES
--ID-Nombre-Descripcion
(1,'Salicaceae','Familia de plantas perteneciente al orden Malpighiales. La componen árboles o arbustos caducifolios y dioicos. Hojas alternas, simples, estipuladas. Flores inconspicuas, unisexuales, aclamídeas, acompañadas de brácteas y reunidas en amentos.'),
(2,'Leguminosae','Familia del orden de las fabales. Reúne árboles, arbustos y hierbas perennes o anuales, fácilmente reconocibles por su fruto tipo legumbre y sus hojas compuestas y estipuladas.Es una familia de distribución cosmopolita con aproximadamente setecientos treinta géneros.'),
(3,'Verbenaceae','Verbenaceae o verbenáceas es una amplia familia de plantas, principalmente tropicales, de árboles, arbustos y hierbas.'),
(4,'Anacardiaceae','Anacardiaceae es una familia de plantas esencialmente arbóreas y arbustivas perteneciente al orden Sapindales. La constituyen 77 géneros con unas 700 especies aceptadas, de las casi 3000 descritas, propias de países tropicales, cálidos y templados.'),
(5,'Euphorbiaceae','Euphorbiaceae es una familia cosmopolita muy difundida y diversificada en la zona tropical con 300 géneros y alrededor de 7500 especies, la mayoría de ellas matas y hierbas aunque también, en especial en los trópicos, árboles y arbustos; monoicas o dioicas, típicamente con látex. Algunas son suculentas que se asemejan a los cactus.'),
(6,'Palmae','Las arecáceas o Palmae son una familia de plantas monocotiledóneas, la única familia del orden Arecales. Normalmente se las conoce como palmeras o palmas. Los individuos de esta importante familia son fáciles de reconocer visualmente, aunque puede haber confusión con especies de las familias Cycadaceae y Zamiaceae debido a las similitudes morfológicas'),
(7,'Flacourtiaceae','Familia de plantas con flores, incluida en varios sistemas de clasificación, entre ellos el de Cronquist, hoy obsoleto. A menudo se le ha achacado a Arthur Cronquist el hábito de incluir en esta familia a todos los miembros que no poseían una clara característica para ser incluidas en otras familias'),
(8,'Combretaceae','Familia del orden de las mirtales, que comprende alrededor de 600 especies de árboles, arbustos y trepadoras en 20 géneros. Su hábitat se extiende por los trópicos y subtrópicos; en ella se encuentran los géneros Laguncularia y Lumnitzera, dos mangles.');
--(9,'',''),
--(10,'',''),
...
(1,1,'Salix humboldtiana Willd','Sauce Criollo','Porte: árbol que alcanza hasta 10 metros de altura, dioico, corteza persistente, inerme.
...
Usos: la madera es blanda y liviana, se utiliza para la fabricación de envases.',0,1000,'Salix_humboldtiana_Willd_001.JPG',500,1,0),
(2,2,'Inga uruguensis Hooker et Arnott','"Ingá", "Angá", "Inga banana","Pacay"','Porte: arbusto de altura media, entre 4 y 10 metros. Ramas con lenticelas en líneas transversales, inerme.
...
Uso:los frutos son comestibles.',0,1000,'Inga_uruguensis_Hooker_et_Arnott_001.JPG',1100,2,1),
(3,3,'Aloysia gratissima','"Cedrón de Monte", "Niñarupá", "Reseda del campo"','Porte: arbusto que alcanza una altura máxima de 3 metros, de aspecto desordenado, con ramas agudo espinosas.
...
(4,3,'Duranta repens','Tala blanco','Porte: arbusto que no alcanza más de cuatro metros de altura, inerme o con pocas espinas, con ramillas cuadrangulares.
...
(5,4,'Schinus molle','"Anacahuita", "Aguaribay", "Molle", "Pimentero"','Porte: árbol que puede alcanzar de 8 a 10 metros de altura, resinoso. Tronco grueso con corteza persistente.
...
(6,5,'Sebastiania klotzschiana Muell','Blanquillo','Porte: árbol que puede alcanzar los 6 metros de altura, de ramas agudo espinosas. Corteza persistente.
...
Usos: no se conocen.
',0,600,'Sebastiania_klotzschiana_Muell_001.JPG',1500,6,0),
(7,6,'Syagrus romanzoffiana','"Pindó", "Chirivá", "Jerivá"','Porte: palmera que puede alcanzar hasta 20 metros de altura, estípite recto de 15 a 30 cm de diámetro, anillado, grisáceo.
...
(8,2,'Parapiptadenia rigida','"Angico", "Angico rojo", "Angico cedro", "Angico de los montes"','Porte:  árbol de 18 a 30 metros de altura. Corteza levemente surcada que se desprende en plaquetas. Tronco recto. Inerme.
...
(9,7,'Xylosma warburgii','Espina corona','Porte: arbusto espinoso de dos a cuatro metros de altura. Follaje: caduco, verde intenso que se torna rojizo en otoño. Ramillas en zig-zag rojizas con lenticelas blancuzcas destacadas, Con espinas simples, rectas, axilares, una por nudo de hasta 5 cm de largo.
...
(10,8,'Terminalia australis','"Palo amarillo", "Amarillo"','Porte: árbol de 7 a 8 metros de altura. Generalmente ramificado desde la base. Inerme.
...
Usos: con sus ramas flexibles se hacen canastos para vivero de peces.',1,800,'Terminalia_australis_001.JPG',1900,10,0),
(11,5,'Sapium montevidense Klotzsch','"Curupí", "Arbol de la leche"','Porte: árbol de 7 a 9 metros de altura, inerme. Tronco algo tortuoso de color grisáceo. Laticífero.
...
(12,3,'Vitex megapotamicus','Tarumán sin espinas','Porte: arbusto de hasta 6 metros de altura, inerme.
