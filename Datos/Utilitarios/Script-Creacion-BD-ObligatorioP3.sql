...
Usos: la madera es blanda y liviana, se utiliza para la fabricaci�n de envases.',0,1000,'Salix_humboldtiana_Willd_001.JPG',500,1,1),
...
Usos: se la utiliza como hierba medicinal y es de gran importancia como mel�fera.',0,300,'Aloysia_gratissima_001.JPG',1200,3,2),
...
Usos: los frutos tienen gusto a pimienta, us�ndose como condimento. La infusi�n de las hojas como medicinal.',2,1000,'Schinus_molle_001.PNG',1400,5,4),
...
Usos: el l�tex se usa para cazar p�jaros, como adhesivo ("pega-pega").',1,900,'Sapium_montevidense_Klotzsch_001.PNG',1000,11,1),
